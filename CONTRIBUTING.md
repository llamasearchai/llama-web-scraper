# Contributing to Llama Web Scraper

Thank you for your interest in contributing to Llama Web Scraper! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Web Scraper:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-web-scraper.git
   cd llama-web-scraper
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-web-scraper.git
   ```
...
By contributing to Llama Web Scraper, you agree that your contributions will be licensed under the project's MIT License.
